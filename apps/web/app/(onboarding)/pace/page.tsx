...
export default function PacePage() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-6 max-w-xl mx-auto w-full">
      <h1 className="text-3xl font-bold mt-12 mb-2 text-center">Set your daily goal</h1>
      <p className="text-gray-500 mb-8 text-center">How much time do you want to spend learning?</p>
      ...
      <div className="flex flex-col gap-4 w-full mb-8">
        {PACES.map(p => (
          ...
          >
            ...
            <span className={selected === p.id ? 'text-blue-600' : 'text-gray-500'}>{p.desc}</span>
          </button>
        ))}
      </div>
